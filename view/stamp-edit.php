    ...
    <main>
        ...
        <input type="hidden" name="stamp_id" value="{{ stamp.stamp_id }}">
            ...
            <select name="condition_quality" id="condition_quality">
                ...
                <option value="{{ condition.condition_quality_id }}"
                {% if stamp.color == condition.condition_quality_id %}
                    selected
                {% endif %}
            ...
            <input type="submit" value="Sauvegarder mes changements">
        </form>
    </main>
</body>
</html>